...
float tab_conv_tx_power[32] = {
    -40.00f, -20.85f, -19.75f, -18.85f, -17.60f, -16.50f, -15.25f, -14.10f,
    -13.15f, -12.05f, -10.90f, -9.90f,  -8.85f,  -7.80f,  -6.90f,  -5.90f,
    -4.95f,  -4.00f,  -3.15f,  -2.45f,  -1.80f,  -1.30f,  -0.85f,  -0.50f,
    -0.15f,  0.00f,   1.00f,   2.00f,   3.00f,   4.00f,   5.00f,   6.00f};
...
uint8_t stm32wb_at_Init(uint8_t *buff_rx, uint8_t buff_rx_size)
{
    ...
    if (buff_rx_size >= sizeof(str_received)) {
        ...
        status = stm32wb_at_ll_Async_receive(0);
        //    status = 0;
    } else {
        status = 1;
    }
 ...
 * @param uint8_t* tab_len  provide the tab size and will hold size of tab
 * converted.
 * @retval 0 in case of success, an error code otherwise
 */
